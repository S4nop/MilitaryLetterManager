...
class MainActivity(QMainWindow):
    ...
    def __init_list_view(self):
        ...
        self.list_widget.setStyleSheet('background-color: {}; border: 0px'.format(resources.color_primary))
    ...
    def __init_background(self):
        ...
        self.bg_top.setStyleSheet('background-color: {}'.format(resources.color_primary))
