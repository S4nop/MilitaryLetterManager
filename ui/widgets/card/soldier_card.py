...
class SoldierCard(CardView):
    ...
    def _init_foreground(self):
        ...
        self.army_picture.setPixmap(QPixmap('./res/img/army_picture.png'))
        ...
        self.left_date_label.setStyleSheet('background-color: rgba(0, 0, 0, 0); Color: #565656')
        ...
        self.soldier_name_label.setStyleSheet('background-color: rgba(0, 0, 0, 0); Color: #565656')
